...
export default function AvatarMenu({ open, name, meta, profileHref, onLogout, onStopClick }) {
  return (
    <div className="pt-popover" id="avatarPopover" hidden={!open} onClick={onStopClick}>
      ...
      <div className="pt-popover-menu">
        ...
        <button className="danger" id="logoutBtn" type="button" onClick={onLogout}>Log out</button>
      </div>
    </div>
  );
}
